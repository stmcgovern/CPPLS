...
private:
    ...
    {0,0.61,0.61,0.60,0.61, 0.61,0.61,0.61,0.61,0.61, 0.61,0.61,0.61,0.61,0.65}; // [-]
    const std::vector<double> surface_permeability
    {1e-200,1e-18,3e-21,4e-21,5e-19, 1e-19,3e-18,4e-18,5e-18, 1e-16,3e-18,4e-18,5e-18}; //m^2
    ...
    {1e-200,1e-8,1e-10,1e-10,5e-10, 1e-9,2e-9,1e-8,8e-8, 5e-9,3e-8,1e-8,8e-8}; //Pa^-1
