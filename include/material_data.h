...
private:
    ...
    {0.61,0.61,0.53,0.4,0.65, 0.61,0.61,0.53,0.4,0.65, 0.61,0.61,0.53,0.4,0.65}; // [-]
    const std::vector<double> surface_permeability
    {2e-40,1e-16,3e-18,4e-18,5e-18, 1e-16,3e-18,4e-18,5e-18, 1e-16,3e-18,4e-18,5e-18}; //m^2
    const std::vector<double> solid_density
    {2720,2720,2320,2820,3020, 2720,2720,2320,2820,3020, 2720,2720,2320,2820,3020, 2720,2720,2320,2820,3020}; // kg/m^3
    const std::vector<double> compressibility_coefficient
    {2e-40,5e-9,3e-8,1e-8,8e-8, 5e-9,3e-8,1e-8,8e-8, 5e-9,3e-8,1e-8,8e-8}; //Pa^-1
